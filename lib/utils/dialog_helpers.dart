    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setDialogState) {
          final dateFormat =
              isEnglish ? 'dd MMM yyyy - h:mm a' : 'dd MMM yyyy - HH:mm';
              ...
              child: Column(
                ...
                children: [
                        ...
                        final pickedTime = await showTimePicker(
                            ...
                            builder: (context, child) => MediaQuery(
                                data: MediaQuery.of(context).copyWith(
                                    alwaysUse24HourFormat: !isEnglish),
                                child: child!));
                        if (pickedTime != null) {
                          setDialogState(() {
                  ...
                  DropdownButton<int>(
                    ...
                    items: [
                      DropdownMenuItem(
                          value: 1, child: Text("🟠 ${loc.highPriority}")),
                      DropdownMenuItem(
                          value: 2, child: Text("🔵 ${loc.mediumPriority}")),
                      DropdownMenuItem(
                          value: 3, child: Text("🟢 ${loc.lowPriority}"))
                    ],
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (selectedDateTime.isBefore(DateTime.now())) {
                    ...
                    Get.snackbar("Hata", "⚠️ ${loc.pastTimeError}",
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () {
                  if (titleController.text.isEmpty) return;
                  if (selectedDateTime != todo.deadline &&
                      selectedDateTime.isBefore(DateTime.now())) {
                    Get.snackbar("Hata", loc.pastTimeError,
                        backgroundColor: Colors.red,
                        colorText: Colors.white,
                        snackPosition: SnackPosition.BOTTOM);
                    return;
                  ...
                  NotificationHelper().scheduleNotification(
                      ...
                      title: "Hatırlatıcı: ${updatedTodo.title}",
                      body: "Zamanı geldi!",
                      scheduledTime: selectedDateTime);
